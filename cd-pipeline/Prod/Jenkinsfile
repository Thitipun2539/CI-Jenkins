...
pipeline {
    ...
    stages {
        ...
        stage('Test') {
            steps {
                ...
                sh 'mvn -s setting.xml test' // Run Maven tests
            }
        }
        ...
        stage('Checkstyle Analysis') {
            steps {
                ...
                sh 'mvn -s setting.xml checkstyle:checkstyle' // Run Checkstyle analysis to ensure code adheres to standards
            }
        }
    ...
    post {
        always {
            ...
            slackSend channel: '#jenkinscicd', // Slack channel to send the notification to
